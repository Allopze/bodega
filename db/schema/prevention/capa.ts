...
export const preventionCapaActions = pgTable("prevention_capa_actions", {
  ...
  check("prevention_capa_source_type_valid", sql`${table.sourceType} IN ('pdtp', 'sst_evaluation', 'ppa', 'incident', 'risk', 'legal_requirement', 'training', 'work_permit', 'inspection', 'cphs', 'emergency', 'change', 'epp', 'manual')`),
