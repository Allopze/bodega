...
export const preventionTrainingCourseVersions = pgTable("prevention_training_course_versions", {
  ...
  check("prevention_training_version_modality_valid", sql`${table.modality} IN ('presencial', 'elearning', 'mixta', 'practica')`),
...
export const preventionTrainingSessions = pgTable("prevention_training_sessions", {
  ...
  check("prevention_training_session_modality_valid", sql`${table.modality} IN ('presencial', 'elearning', 'mixta', 'practica')`),
