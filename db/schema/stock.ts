...
export const inventoryMovements = pgTable("inventory_movements", {
  ...
  check("inventory_movements_type_valid", sql`
    ${table.type} IN ('ingreso_oc', 'egreso_entrega', 'ingreso_devolucion', 'egreso_desecho', 'retiro_epp_trabajador', 'ajuste', 'egreso_traslado', 'ingreso_traslado', 'ingreso_anulacion', 'egreso_anulacion')
  `),
