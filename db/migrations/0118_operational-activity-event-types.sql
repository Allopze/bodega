-- La actividad operacional nace desde audit_log en la misma transacción de
-- cada mutación. Conservamos una sola escritura y hacemos semánticos los
-- eventos de abastecimiento sin copiar estados ni motivos potencialmente
-- sensibles al stream transversal.
...
BEGIN
  ...
  ELSIF NEW.entity_type = 'purchase_request' THEN
    ...
    END CASE;
  ELSIF NEW.entity_type = 'purchase_request_item' THEN
    CASE target_status
