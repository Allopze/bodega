-- Las etapas intermedias del ítem siguen siendo auditables aunque no tengan
-- una etiqueta semántica propia en el centro operacional.
...
BEGIN
  ...
  IF NEW.entity_type = 'purchase_order' THEN
    CASE
      ...
      ELSE target_event_type := target_event_type;
    END CASE;
