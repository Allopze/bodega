...
describe("prevention PDTP service", () => {
   ...
   * cambios de forma de `schemaVersion` ≥13, ≥14, ≥15 y ≥16
   * (executorAssignments, mechanism, alcance corporativo y objetivos); las
   * versiones 9 a 11 quedan incorporadas sin condición y no
