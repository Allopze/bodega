...
export const NUEVO_SECTIONS: ChecklistSection[] = [
  ...
  // ============================================================
  {
    ...
    items: [
      { id: 'contrato_trabajo',        label: 'Contrato de trabajo firmado', kind: 'cumple_nocumple_obs' },
      { id: 'examen_preocupacional',    label: 'Examen preocupacional vigente de acuerdo al cargo', kind: 'cumple_nocumple_obs' },
      { id: 'licencia_conducir',        label: 'Licencia de conducir correspondiente al equipo a conducir u operar', kind: 'cumple_nocumple_obs' },
      { id: 'certificacion_competencias', label: 'Certificación de competencias', kind: 'cumple_nocumple_obs' },
      { id: 'declaracion_salud',        label: 'Declaración de salud', kind: 'cumple_nocumple_obs' },
    ],
  },
  ...
  // ============================================================
  {
    ...
    countsForCompliance: true,
    items: [
      { id: 'induccion_irl',            label: 'Inducción IRL', kind: 'cumple_nocumple_obs' },
      { id: 'riohs',                    label: 'Reglamento interno de orden, higiene y seguridad', kind: 'cumple_nocumple_obs' },
      { id: 'procedimientos_operacionales', label: 'Procedimientos operacionales de trabajo', kind: 'cumple_nocumple_obs' },
      { id: 'procedimiento_do53',       label: 'Procedimiento de conducción DO-53', kind: 'cumple_nocumple_obs' },
      { id: 'piensa_actua',             label: 'Programa Piensa y Actúa', kind: 'cumple_nocumple_obs' },
      { id: 'alcohol_drogas',           label: 'Procedimiento de alcohol y drogas', kind: 'cumple_nocumple_obs' },
      { id: 'protocolos_minsal',        label: 'Protocolos Minsal', kind: 'cumple_nocumple_obs' },
      { id: 'capacitacion_epp',         label: 'Capacitación: gestión de los elementos de protección personal', kind: 'cumple_nocumple_obs' },
    ],
  },
  ...
  // ============================================================
  {
    ...
    weekNumber: 1,
    items: [
      { id: 'procedimientos_trabajo_seguro', label: 'Cumple procedimientos operativos de trabajo seguro', kind: 'cumple_nocumple_obs' },
      { id: 'zonas_estacionamiento',         label: 'Respeta zonas establecidas de estacionamiento', kind: 'cumple_nocumple_obs' },
      { id: 'distancias_estacionamiento',    label: 'Respeta distancias de seguridad al estacionarse cerca de equipos, estructuras u otros obstáculos', kind: 'cumple_nocumple_obs' },
      { id: 'conductas_preventivas',         label: 'Mantiene conductas preventivas', kind: 'cumple_nocumple_obs' },
      { id: 'sin_exceso_confianza',          label: 'No incurre en excesos de confianza', kind: 'cumple_nocumple_obs' },
      { id: 'aplica_piensa_actua',           label: 'Aplica Piensa y Actúa', kind: 'cumple_nocumple_obs' },
    ],
  },
