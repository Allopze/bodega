 ...
 *
 * Vive en `lib/` (no en una carpeta de feature) para que tanto la UI como los
 * servicios de exportación importen el mismo mapa sin depender de `app/`.
 * `app/(app)/bodega/movement-labels.ts` re-exporta esto por compatibilidad.
 */
