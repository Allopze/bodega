...
|---|---|---|
| 2026-09-18 | [2026-09-18-pdtp-programa-preventivo.md](2026-09-18-pdtp-programa-preventivo.md) | Implementación focalizada de diferencias del Programa Preventivo: creador unificado, calendario/instancias, 14 conectores, eventos, evidencia, recordatorios, cumplimiento, enlace nativo, exportación ISO y destinos dinámicos de `/pendientes`; migraciones 0307–0309 y backfill aplicados solo en desarrollo, dry-run idempotente; PGlite 2.108/2.108, test:fast 732 archivos PASS/30 omitidos con 2 fallas ajenas, E2E 659 PASS/25 fallas/3 omitidos; no es certificación global |
