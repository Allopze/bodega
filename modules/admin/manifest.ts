...
export const adminModule = {
  ...
  permissionMeta: {
    ...
    "admin:worker_positions":  { id: "p-adm-wrkpos", description: "Gestionar catálogo de cargos y capacidades de trabajadores" },
  ...
  defaultGrants: [
    ...
    { roleSlug: "administrador", permission: "admin:worker_positions" },
    ...
    { roleSlug: "jefa_chome", permission: "admin:worker_positions" },
    ...
    { roleSlug: "prevencionista", permission: "admin:worker_positions" },
