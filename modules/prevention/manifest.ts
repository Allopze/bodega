...
export const preventionModule = {
  ...
  permissionMeta: {
    ...
    "prevention:docs:manage":             { id: "p-prev-docs-m",    description: "Subir, editar metadata y crear versiones de documentos" },
    "prevention:docs:approve":            { id: "p-prev-docs-a",    description: "Aprobar, observar o archivar documentos" },
    "prevention:docs:archive":            { id: "p-prev-docs-arch", description: "Archivar (soft delete) documentos" },
    "prevention:docs:ack":                { id: "p-prev-docs-ack",  description: "Registrar acuse de lectura / recepción de documentos" },
    "prevention:docs:link":               { id: "p-prev-docs-link", description: "Asociar documentos con entidades internas (trabajador, faena, vehículo, etc.)" },
    "prevention:docs:export":             { id: "p-prev-docs-e",    description: "Exportar listados de documentación (XLSX)" },
  ...
  nav: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          children: [
            { label: "Bandeja de revisión", href: "/prevencion/documentacion/revisiones", permissions: ["prevention:docs:approve"] },
            { label: "Vencimientos",        href: "/prevencion/documentacion/vencimientos", permissions: ["prevention:docs:view"] },
          ],
        },
      ],
    },
