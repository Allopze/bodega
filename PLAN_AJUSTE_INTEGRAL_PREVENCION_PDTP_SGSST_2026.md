...
- Gate de fase: Fase 5 avanza más (solo `campana` y el motor de auto-emisión quedan bloqueados por la matriz 1-87); Fase 6.1 cierra dos items pendientes (navegación KPI exacta, verificación Excel). Ninguna fase pasa a "cerrada" formalmente — persisten los gates de aceptación productiva del §10/§15.
- Aprobado por: pendiente.
