...
export async function PdtpScheduledActivityPanelServer({ connectorKey }: { connectorKey: string }) {
  let session
  try {
  ...
  return <PdtpScheduledActivityPanel rows={rows} connectorLabel={connector.label} />
}
