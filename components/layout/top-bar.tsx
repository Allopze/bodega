...
const ROUTES_WITH_OWN_SEARCH = ["/solicitudes", "/aprobaciones", "/compras", "/recepcion", "/pendientes", "/bodega", "/flota", "/mantenciones", "/prevencion/ppa", "/prevencion/inspecciones", "/facturacion/facturas", "/trazabilidad/documento"]
