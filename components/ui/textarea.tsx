    ...
    return (
      <textarea
        ...
        className={cn(
          ...
          "hover:border-[var(--color-border-strong)]",        "active:border-[var(--color-border-strong)]",          "focus:outline-none focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary-100)]",
