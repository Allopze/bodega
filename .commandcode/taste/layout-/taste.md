...
- Collapsed sidebar must use `rounded-full` borders to match header pill style. Confidence: 0.80
- Collapsed sidebar width should be narrow (w-16/64px) to match header pill proportions. Confidence: 0.80
- Sidebar categories must appear hierarchically superior to subcategories through visual styling. Confidence: 0.75
