...
const routeTargets: RouteTarget[] = [
  ...
  { slug: "prevencion-auditorias-catalogo", path: "/prevencion/auditorias/catalogo", auth: true, notes: "Espejo del catálogo de inspecciones acotado a kind=audit: sin él, las plantillas de auditoría aparecían bajo Inspecciones." },
