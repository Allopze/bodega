...
async function main() {
  ...
  // Las faenas de una revisión borrador sí se pueden ajustar; la versión
  // activa se conserva como expediente firmado y sólo queda como fallback
  // informativo cuando aún no existe una revisión abierta.
