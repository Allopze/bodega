...
// `authorization`; la URL con su query, el cuerpo de la petición, las cookies
// parseadas, `extra` y el usuario completo viajaban al proveedor de
// telemetría. La depuración ahora vive en un único módulo compartido por los
// tres runtimes, que antes repetían el mismo filtro insuficiente tres veces.
