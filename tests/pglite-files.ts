...
export const pgliteTestFiles = [
  ...
  "lib/__tests__/prevention-risk-export-roundtrip.test.ts",
  "lib/__tests__/prevention-risk-capa-postgres.test.ts",
  "lib/__tests__/prevention-risk-matrix-view-postgres.test.ts",
  "lib/__tests__/prevention-risk-approvals-postgres.test.ts",
  "lib/__tests__/prevention-risk-diff-postgres.test.ts",
  "lib/__tests__/prevention-risk-notifications.test.ts",
