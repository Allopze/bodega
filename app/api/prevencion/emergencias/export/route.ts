...
import { buildEmergencyExport } from "@/lib/services/prevention-emergency"
...
export async function GET() {
  ...
  try {
    const report = await buildEmergencyExport(wsIds)
    ...
    logger.error("[prevencion/emergencias/export]", err)
