...
const LINKS = [
  {
    ...
    href:        "/combustibles/vehiculos",
    icon:        Truck,
    permission:  "combustibles:manage_vehicles",
  },
  {
    title:       "Proveedores de combustible",
    description: "Mantén el listado maestro de proveedores y sus condiciones.",
    href:        "/combustibles/proveedores-combustible",
    icon:        GasPump,
    permission:  "combustibles:manage_vehicles",
  },
  {
