...
/**
 * Detail view for a "servicios" purchase request, rendered inline by
 * /solicitudes/[id] (servicios no longer has its own route).
 */
export async function ServiceDetailView({ id }: { id: string }) {
  let session
