...
export function ServiceQuotationPanel({
  ...
  quotations:    ServiceQuotationRow[]
  canUpload:     boolean
  canApprove:    boolean
}) {
  ...
  const supplierLabel = (q: ServiceQuotationRow) =>
    ...
    <div className="rounded-[var(--radius-2xl)] bg-[var(--color-surface)] shadow-[var(--shadow-card)] p-6 space-y-4">
            ...
            >
              ...
              <div className="min-w-0 flex-1 space-y-1">
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-0.5 text-xs text-[var(--color-text-muted)]">
                  ...
                  <a
                    href={`/api/servicios/cotizaciones/${q.id}`}
                    target="_blank"
      ...
      {isApproved && (
        <p className="text-xs text-[var(--color-success-ink)] font-medium">
          ✓ Cotización aprobada. Servicios listos para orden de compra en el módulo de Compras.
        </p>
      )}
        ...
        <DialogContent className="sm:max-w-lg">
          ...
          <form action={uploadAction} className="space-y-4">
            ...
            <Field label="Observaciones">
              <Input
                name="notes"
                placeholder="Condiciones de pago, plazo de ejecución..."
                maxLength={300}
              />
            </Field>
        ...
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              y todos los servicios de la solicitud pasarán al estado &quot;Aprobado&quot; para orden de compra.
            </DialogDescription>
          </DialogHeader>
