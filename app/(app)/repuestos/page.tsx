...
import { RepuestoList } from "./request-list"

export const metadata: Metadata = { title: "Solicitudes de repuestos" }
...
export default async function RepuestosPage() {
  ...
  const viewAll = can(session, "repuestos:view_all")
  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        description="Solicitudes de repuestos para vehículos y maquinaria."
        breadcrumb={
          <Breadcrumbs items={[
      ...
      <RepuestoList
        requests={rows}
        canCreate={can(session, "repuestos:create")}
