...
import { ArrowLeft, Info, Plus, Warning, Trash } from "@phosphor-icons/react"
...
function ItemsSection({
  items, requestType, requestTypeLabel, readOnly, savedId, itemsError,
...
function SummarySidebar({
  isDraft, readOnly, worksiteLabel, requestTypeLabel, urgencyLabel, requiredDate,
