...
type VehicleOption = { id: string; plate: string; type: string }
...
export function MaintenanceTable({
  records, canEdit, canCreate, hasActiveFilters, statusLabels, vehicleOptions, supplierOptions, worksiteOptions, costCenterOptions,
}: {
  ...
  return (
    <DataTable
      ...
      columns={columns}
      rows={rows}
      searchKeys={["plate", "maintenanceType", "supplierName", "documentLabel"]}
      ...
      emptyAction={hasActiveFilters
        ...
        : canCreate
          ? <MaintenanceCreateButton vehicles={vehicleOptions} suppliers={supplierOptions} worksites={worksiteOptions} costCenters={costCenterOptions} />
          : undefined}
      renderRow={(record) => {
