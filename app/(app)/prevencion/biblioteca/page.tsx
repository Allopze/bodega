...
export const metadata: Metadata = { title: "Biblioteca SST" }
...
export default async function BibliotecaPage({
  ...
  return (
    <PageContainer width="workbench">
      <Breadcrumbs items={[{ label: "Prevención", href: "/prevencion" }, { label: "Biblioteca SST" }]} />
      <PageHeader
        title="Biblioteca documental SST"
        description="Documentación preventiva interna. Vencimientos, versiones, aprobaciones y acuses."
        actions={
          canExport ? (
            <PreventionExportButton
              href="/api/prevencion/biblioteca/export"
              label="Exportar XLSX"
            />
          ) : undefined
        }
