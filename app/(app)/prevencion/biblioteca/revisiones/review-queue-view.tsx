          ...
          <Table>
            ...
            <TableBody>
              {documents.map((d) => (
                <TableRow key={d.id}>
                  <TableCell>
                    <Link href={`/prevencion/biblioteca/${d.id}`} className="font-medium hover:underline">
                      {d.title}
                    </Link>
                  ...
                  <TableCell>
                    <Link href={`/prevencion/biblioteca/${d.id}`} className="text-sm text-[var(--color-primary)] hover:underline">
                      Revisar
                    </Link>
                  </TableCell>
                </TableRow>
