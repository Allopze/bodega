...
/**
 * Estado compartido de los formularios de permisos: pendiente + mensaje. El
 * mensaje de error viene del servicio, que es donde viven las reglas (piso de
 * habilitación, secuencia de estados, versión optimista), así que se muestra
 * tal cual en vez de traducirlo a un texto genérico.
 */
...
/** Textarea de una línea por elemento → array, sin widget dinámico. */
