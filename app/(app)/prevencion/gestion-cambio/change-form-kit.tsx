...
/**
 * Estado compartido de los formularios de gestión del cambio: pendiente +
 * mensaje. El mensaje de error viene del servicio, que es donde viven las
 * reglas (disponibilidad para aprobar, segregación de aprobación), así que
 * se muestra tal cual en vez de traducirlo a un texto genérico.
 */
