...
/**
 * Estado compartido de los formularios de higiene: pendiente + mensaje. El
 * mensaje de error viene del servicio, que es donde viven las reglas (límite
 * congelado en la medición, matrícula derivada del GES), así que se muestra
