      ...
      <DialogContent>
        <form onSubmit={submit} className="space-y-4">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            ...
            <Field label="Tipo">
              <select name="agentType" className={selectClass} required>
      ...
      <DialogContent>
        <form onSubmit={submit} className="space-y-4">
          ...
          <Field label="Agente de exposición">
            <select name="agentId" className={selectClass} required>
              {agents.map((item) => <option key={item.id} value={item.id}>{item.name} ({item.unit})</option>)}
            </select>
          </Field>
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            ...
            <Field label="Agente asociado" hint="Opcional.">
              <select name="agentId" className={selectClass} defaultValue="">
