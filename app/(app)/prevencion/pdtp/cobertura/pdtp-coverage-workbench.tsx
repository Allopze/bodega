...
/** Opciones pickeables por `sourceType`; los tipos sin entidad propia (auditoría, objetivo interno, obligación contractual, campaña) caen al identificador de texto libre. */
...
const SOURCE_LABELS: Record<string, string> = {
  ...
  audit: "Auditoría", internal_objective: "Objetivo interno", contractual_obligation: "Obligación contractual",
