...
/**
 * Estado compartido de los formularios de capacitación: pendiente + mensaje.
 * El mensaje de error viene del servicio, que es donde viven las reglas
 * (piso legal, convocados sin resultado, versión optimista), así que se muestra
