...
vi.mock("../actions", () => ({
  ...
  submitSstDocumentVersionForReviewAction: vi.fn(),
  returnObservedSstDocumentVersionToDraftAction: vi.fn(),
  markSstDocumentVersionReviewedAction: vi.fn(),
  observeSstDocumentVersionAction: vi.fn(),
  approveSstDocumentVersionAction: vi.fn(),
  publishSstDocumentVersionAction: vi.fn(),
  acknowledgeSstDocumentVersionAction: vi.fn(),
  assignSstDocumentRecipientsAction: vi.fn(),
  exemptSstDocumentRecipientAction: vi.fn(),
}))
