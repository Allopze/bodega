...
export default function FuelCycleError({
  ...
  return (
    <div className="flex min-h-[50vh] items-center justify-center p-8">
      <EmptyState
        as="h1"
        icon={isNetwork ? <WifiSlash size={24} /> : <ArrowsClockwise size={24} />}
        title={isNetwork ? "Error de conexión" : "Error al cargar la conciliación"}
        description={isNetwork
          ? "No se pudo conectar con el servidor. Verifica tu conexión a internet y que el servicio esté disponible."
          : "No se pudo consultar el ciclo físico. Intenta nuevamente o reporta el error si persiste."
        }
