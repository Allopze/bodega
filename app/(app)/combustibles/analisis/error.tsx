...
export default function EquipmentPerformanceError({
  error,
  unstable_retry,
}: {
  ...
  return (
    <div className="flex min-h-[50vh] items-center justify-center p-8">
      <EmptyState
        ...
        title={isNetwork ? "Error de conexión" : "Error al cargar el análisis de rendimiento"}
        description={isNetwork
          ? "No se pudo conectar con el servidor. Verifica tu conexión a internet y que el servicio esté disponible."
          : "No se pudo calcular el análisis. Intenta nuevamente o reporta el error si persiste."
        }
