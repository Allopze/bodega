...
const COVERAGE: Record<string, StateMetaInput> = {
  both_channels: { label: "Ambos", variant: "primary" },
  tae_only: { label: "Solo TAE", variant: "warning" },
  tct_only: { label: "Solo TCT", variant: "info" },
}
